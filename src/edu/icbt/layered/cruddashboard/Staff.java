...
public class Staff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Our Crew Members");
        ...
        jLabel3.setText("Get to Know the Faces Behind the Beauty");
...
private void loadTable() {
        ...
        try {
            String[] columns = {"Employee Name", " Gmail", "Position"};
            ...
            for (UserDto userDto : userDtos) {
                Object[] rowData = {userDto.getUserName(), userDto.getGmail(), userDto.getPosition()};
                dtm.addRow(rowData);
            }
        } catch (Exception ex) {
